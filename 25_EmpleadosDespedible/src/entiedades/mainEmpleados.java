...
public class mainEmpleados {
	...
	public static Programador darDeAltaProgramador(Scanner sc) {
		...
		programador.setSalarioTotal(sc.nextDouble());
		sc.hasNextLine();
	...
	public static JefeProyecto darDeAltaJefeProy(Scanner sc) {
		...
		jefeProy.setSalarioTotal(sc.nextDouble());
		sc.hasNextLine();
	...
	public static Director darDeAltaDirector(ArrayList<Empleado> listaEmpleados,
		...
		System.out.println("Salario total:");
		director.setSalarioTotal(sc.nextDouble());
		sc.nextLine();
	...
	public static void mostrarCantidadesPorDespido() {
